 ...
 *       &lt;sequence&gt;
 *         &lt;element name="Geometry" type="{http://schemas.datacontract.org/2004/07/ConsoleApp_for_Rooting_Server}Geometry" minOccurs="0"/&gt;
 *         &lt;element name="Properties" type="{http://schemas.datacontract.org/2004/07/ConsoleApp_for_Rooting_Server}Properties" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
public class Feature {
    ...
    @XmlElementRef(name = "Geometry", namespace = "http://schemas.datacontract.org/2004/07/ConsoleApp_for_Rooting_Server", type = JAXBElement.class, required = false)
    protected JAXBElement<Geometry> geometry;
    @XmlElementRef(name = "Properties", namespace = "http://schemas.datacontract.org/2004/07/ConsoleApp_for_Rooting_Server", type = JAXBElement.class, required = false)
